...
## Prerequisites[](https://docs.docker.com/network/ipvlan/#prerequisites)
...
## IPvlan L2 mode example usage[](https://docs.docker.com/network/ipvlan/#ipvlan-l2-mode-example-usage)
...
![Simple IPvlan L2 Mode Example](https://docs.docker.com/network/images/ipvlan_l2_simple.png)
...
![Multiple IPvlan Hosts](https://docs.docker.com/network/images/macvlan-bridge-ipvlan-l2.png)
...
## IPvlan 802.1q trunk L2 mode example usage[](https://docs.docker.com/network/ipvlan/#ipvlan-8021q-trunk-l2-mode-example-usage)
...
![Docker VLANs in Depth](https://docs.docker.com/network/images/vlans-deeper-look.png)
...
### VLAN ID 20[](https://docs.docker.com/network/ipvlan/#vlan-id-20)
...
### VLAN ID 30[](https://docs.docker.com/network/ipvlan/#vlan-id-30)
...
## IPvlan L3 mode example[](https://docs.docker.com/network/ipvlan/#ipvlan-l3-mode-example)
...
![Docker IPvlan L2 Mode](https://docs.docker.com/network/images/ipvlan-l3.png)
...
## Dual stack IPv4 IPv6 IPvlan L2 mode[](https://docs.docker.com/network/ipvlan/#dual-stack-ipv4-ipv6-ipvlan-l2-mode)
...
## Dual stack IPv4 IPv6 IPvlan L3 mode[](https://docs.docker.com/network/ipvlan/#dual-stack-ipv4-ipv6-ipvlan-l3-mode)
...
## Manually create 802.1q links[](https://docs.docker.com/network/ipvlan/#manually-create-8021q-links)

### VLAN ID 40[](https://docs.docker.com/network/ipvlan/#vlan-id-40)
