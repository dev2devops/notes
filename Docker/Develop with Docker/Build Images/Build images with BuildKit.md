...
For more information on build options, see the reference guide on the [command line build options](https://docs.docker.com/engine/reference/commandline/build/) and the [Dockerfile reference](https://docs.docker.com/engine/reference/builder/) page.

## Requirements[](https://docs.docker.com/develop/develop-images/build_enhancements/#requirements)

-   A current version of Docker (18.09 or higher)
-   Network connection required for downloading images of custom frontends

## Limitations[](https://docs.docker.com/develop/develop-images/build_enhancements/#limitations)

-   Only supported for building Linux containers

## To enable BuildKit builds[](https://docs.docker.com/develop/develop-images/build_enhancements/#to-enable-buildkit-builds)
...
## New Docker Build command line build output[](https://docs.docker.com/develop/develop-images/build_enhancements/#new-docker-build-command-line-build-output)
...
## Overriding default frontends[](https://docs.docker.com/develop/develop-images/build_enhancements/#overriding-default-frontends)
...
> **Acknowledgment**
> 
> Please see [Build secrets and SSH forwarding in Docker 18.09](https://medium.com/@tonistiigi/build-secrets-and-ssh-forwarding-in-docker-18-09-ae8161d066) for more information and examples.
...
First, run `ssh-add` to add private key identities to the authentication agent. If you have more than one SSH key and your default `id_rsa` is not the one you use for accessing the resources in question, you’ll need to add that key by path: `ssh-add ~/.ssh/<some other key>`. (For more information on SSH agent, see the [OpenSSH man page](https://man.openbsd.org/ssh-agent).)
...
## Troubleshooting : issues with private registries[](https://docs.docker.com/develop/develop-images/build_enhancements/#troubleshooting--issues-with-private-registries)
...
Solution: secure your registry properly. You can get SSL certificates from Let’s Encrypt for free. See [Deploy a registry server](https://docs.docker.com/registry/deploying/).
