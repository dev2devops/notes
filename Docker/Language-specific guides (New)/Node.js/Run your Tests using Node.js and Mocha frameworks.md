...
## Prerequisites[](https://docs.docker.com/language/nodejs/run-tests/#prerequisites)

Work through the steps to build an image and run it as a containerized application in [Use your container for development](https://docs.docker.com/language/nodejs/develop/).

## Introduction[](https://docs.docker.com/language/nodejs/run-tests/#introduction)
...
## Create a test[](https://docs.docker.com/language/nodejs/run-tests/#create-a-test)
...
### Running locally and testing the application[](https://docs.docker.com/language/nodejs/run-tests/#running-locally-and-testing-the-application)
...
## Install Mocha[](https://docs.docker.com/language/nodejs/run-tests/#install-mocha)
...
## Update package.json and Dockerfile to run tests[](https://docs.docker.com/language/nodejs/run-tests/#update-packagejson-and-dockerfile-to-run-tests)
...
### Multi-stage Dockerfile for testing[](https://docs.docker.com/language/nodejs/run-tests/#multi-stage-dockerfile-for-testing)
