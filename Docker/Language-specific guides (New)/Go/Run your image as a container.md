...
## Prerequisites[](https://docs.docker.com/language/golang/run-containers/#prerequisites)

Work through the steps to dockerize a Go application in [Build your Go image](https://docs.docker.com/language/golang/build-images/).

## Overview[](https://docs.docker.com/language/golang/run-containers/#overview)
...
## Run in detached mode[](https://docs.docker.com/language/golang/run-containers/#run-in-detached-mode)
...
## List containers[](https://docs.docker.com/language/golang/run-containers/#list-containers)
...
## Stop, start, and name containers[](https://docs.docker.com/language/golang/run-containers/#stop-start-and-name-containers)
