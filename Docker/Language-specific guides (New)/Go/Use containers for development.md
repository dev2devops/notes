...
## Prerequisites[](https://docs.docker.com/language/golang/develop/#prerequisites)

Work through the steps of the [run your image as a container](https://docs.docker.com/language/golang/run-containers/) module to learn how to manage the lifecycle of your containers.

## Introduction[](https://docs.docker.com/language/golang/develop/#introduction)
...
## Local database and containers[](https://docs.docker.com/language/golang/develop/#local-database-and-containers)
...
### Storage[](https://docs.docker.com/language/golang/develop/#storage)

The point of a database is to have a persistent store of data. [Volumes](https://docs.docker.com/storage/volumes/) are the preferred mechanism for persisting data generated by and used by Docker containers. Thus, before we start CockroachDB, let’s create the volume for it.
...
### Networking[](https://docs.docker.com/language/golang/develop/#networking)
...
Our bridge network `mynet` has been created successfully. The other three networks, named `bridge`, `host`, and `none` are the _default_ networks and they had been created by the Docker itself. While it is not relevant to our current discussion, you can learn more about Docker networking in the [networking overview](https://docs.docker.com/network/) section.

### Choose good names for volumes and networks[](https://docs.docker.com/language/golang/develop/#choose-good-names-for-volumes-and-networks)
...
### Start the database engine[](https://docs.docker.com/language/golang/develop/#start-the-database-engine)
...
### Configure the database engine[](https://docs.docker.com/language/golang/develop/#configure-the-database-engine)
...
### Meet the example application[](https://docs.docker.com/language/golang/develop/#meet-the-example-application)
...
### Build the application[](https://docs.docker.com/language/golang/develop/#build-the-application)
...
### Run the application[](https://docs.docker.com/language/golang/develop/#run-the-application)
...
### Test the application[](https://docs.docker.com/language/golang/develop/#test-the-application)
...
### Wind down everything[](https://docs.docker.com/language/golang/develop/#wind-down-everything)
...
## Better productivity with Docker Compose[](https://docs.docker.com/language/golang/develop/#better-productivity-with-docker-compose)
...
### Configure Docker Compose[](https://docs.docker.com/language/golang/develop/#configure-docker-compose)
...
This Docker Compose configuration is super convenient as we do not have to type all the parameters to pass to the `docker run` command. We can declaratively do that in the Docker Compose file. The [Docker Compose documentation pages](https://docs.docker.com/compose/) are quite extensive and include a full reference for the Docker Compose file format.

### The `.env` file[](https://docs.docker.com/language/golang/develop/#the-env-file)
...
### Merging Compose files[](https://docs.docker.com/language/golang/develop/#merging-compose-files)
...
### Variable substitution in Docker Compose[](https://docs.docker.com/language/golang/develop/#variable-substitution-in-docker-compose)

One of the really cool features of Docker Compose is [variable substitution](https://docs.docker.com/compose/compose-file/compose-file-v3/#variable-substitution). You can see some examples in our Compose file, `environment` section. By means of an example:
...
Other ways of dealing with undefined or empty values exist, as documented in the [variable substitution](https://docs.docker.com/compose/compose-file/compose-file-v3/#variable-substitution) section of the Docker documentation.

### Validating Docker Compose configuration[](https://docs.docker.com/language/golang/develop/#validating-docker-compose-configuration)
...
### Build and run the application using Docker Compose[](https://docs.docker.com/language/golang/develop/#build-and-run-the-application-using-docker-compose)
...
### Testing the application[](https://docs.docker.com/language/golang/develop/#testing-the-application)
...
### Shutting down[](https://docs.docker.com/language/golang/develop/#shutting-down)
...
### Detached mode[](https://docs.docker.com/language/golang/develop/#detached-mode)
...
## Further exploration[](https://docs.docker.com/language/golang/develop/#further-exploration)

We would suggest running `docker-compose` to see what other commands are available.

## Wrap up[](https://docs.docker.com/language/golang/develop/#wrap-up)
...
### Persistent storage[](https://docs.docker.com/language/golang/develop/#persistent-storage)

A _managed volume_ isn’t the only way to provide your container with persistent storage. It is highly recommended to get acquainted with available storage options and their use cases, covered in the following part of Docker documentation: [Manage data in Docker](https://docs.docker.com/storage/).

### CockroachDB clusters[](https://docs.docker.com/language/golang/develop/#cockroachdb-clusters)
...
-   Documentation for Docker Compose keywords [`deploy`](https://docs.docker.com/compose/compose-file/compose-file-v3/#deploy) and [`replicas`](https://docs.docker.com/compose/compose-file/compose-file-v3/#replicas).

### Other databases[](https://docs.docker.com/language/golang/develop/#other-databases)
