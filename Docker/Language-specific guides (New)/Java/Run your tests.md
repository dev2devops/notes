#Docker #Java 
# Run your tests
## Prerequisites[](https://docs.docker.com/language/java/run-tests/#prerequisites)

Work through the steps to build an image and run it as a containerized application in [Use your container for development](https://docs.docker.com/language/java/develop/).

## Introduction[](https://docs.docker.com/language/java/run-tests/#introduction)
...
## Refactor Dockerfile to run tests[](https://docs.docker.com/language/java/run-tests/#refactor-dockerfile-to-run-tests)
...
### Multi-stage Dockerfile for development[](https://docs.docker.com/language/java/run-tests/#multi-stage-dockerfile-for-development)
